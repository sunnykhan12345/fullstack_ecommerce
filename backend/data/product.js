...
const products = [
  {
    ...
    tags: ["shirt", "casual", "formal"], // Added
    user: "65f8c1b2e4b0f3a9c8f1b2e4", // Placeholder ObjectId
    metaTitle: "Classic Oxford Shirt", // Added
    metaDescription: "A classic Oxford shirt for a polished look.", // Added
    dimensions: { length: 30, width: 20, height: 2 }, // Added
    weight: 0.5, // Added
  },
  {
    name: "Slim-Fit Stretch Shirt",
    ...
    brand: "Modern Fit",
    sizes: ["S", "M", "L", "XL"],
    colors: ["Black"], // Adjusted to match enum
    collections: "Formal Wear",
    material: "Cotton Blend",
    gender: "Men",
    images: [
    ...
    isFeatured: false, // Added
    isPublished: true, // Added
    tags: ["shirt", "slim-fit", "formal"], // Added
    user: "65f8c1b2e4b0f3a9c8f1b2e4", // Placeholder ObjectId
    metaTitle: "Slim-Fit Stretch Shirt", // Added
    metaDescription: "A slim-fit shirt for business or evening events.", // Added
  ...
  },
  {
    ...
    isFeatured: false, // Added
    isPublished: true, // Added
    tags: ["shirt", "denim", "casual"], // Added
    user: "65f8c1b2e4b0f3a9c8f1b2e4", // Placeholder ObjectId
    metaTitle: "Casual Denim Shirt", // Added
    metaDescription: "A casual denim shirt for everyday wear.", // Added
    dimensions: { length: 30, width: 20, height: 2 }, // Added
    weight: 0.5, // Added
  },
  {
    ...
    brand: "Beach Breeze",
    sizes: ["S", "M", "L", "XL"],
    colors: ["White"], // Adjusted to match enum
    collections: "Vacation Wear",
    material: "Viscose",
    gender: "Men",
    images: [
    ...
    isFeatured: false, // Added
    isPublished: true, // Added
    tags: ["shirt", "summer", "vacation"], // Added
    user: "65f8c1b2e4b0f3a9c8f1b2e4", // Placeholder ObjectId
    metaTitle: "Printed Resort Shirt", // Added
    metaDescription: "A printed resort shirt for summer vacations.", // Added
    dimensions: { length: 28, width: 18, height: 2 }, // Added
    weight: 0.4, // Added
  },
  {
